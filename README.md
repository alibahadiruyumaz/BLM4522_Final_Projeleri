...
### 3. [Proje 7: Veritabanı Yedekleme ve Otomasyon Çalışması](./Proje_7_Yedekleme_Otomasyon/Yedekleme_Otomasyon_Raporu.md)
SQL Server Agent kullanılarak operasyonel yükün minimize edilmesi ve olası hata durumlarında tetiklenen olay yönelimli (Event-Driven) bildirim betiklerinin inşası.